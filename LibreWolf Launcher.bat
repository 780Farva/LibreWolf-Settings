...
del "%~dp0\Profiles\Default\activity-stream.weather_feed.json" >nul 2>&1
del "%~dp0\Profiles\Default\cert_override.txt" >nul 2>&1
del "%~dp0\Profiles\Default\cookies.sqlite-wal" >nul 2>&1
del "%~dp0\Profiles\Default\enumerate_devices.txt" >nul 2>&1
del "%~dp0\Profiles\Default\extensions.json.pbak" >nul 2>&1
del "%~dp0\Profiles\Default\favicons.sqlite" >nul 2>&1
del "%~dp0\Profiles\Default\favicons.sqlite-shm" >nul 2>&1
del "%~dp0\Profiles\Default\favicons.sqlite-wal" >nul 2>&1
del "%~dp0\Profiles\Default\formhistory.sqlite" >nul 2>&1
...
del "%~dp0\Profiles\Default\serviceworker.txt" >nul 2>&1
del "%~dp0\Profiles\Default\times.json" >nul 2>&1
...
rd /s /q "%~dp0\Profiles\Default\extensions\trash" >nul 2>&1
